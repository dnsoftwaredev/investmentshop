...
export const approveOrder = (order) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`/api/orders/${order._id}/approve`, {}, config);
