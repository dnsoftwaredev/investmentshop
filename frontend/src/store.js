...
import { orderCreateReducer, orderDetailsReducer, orderPayReducer, orderListMyReducer, orderListReducer, orderApproveReducer } from './reducers/orderReducers';
...
const initialState = {
    cart: { cartItems: cartItemsFromStorage, billingAddress: billingAddressFromStorage },
